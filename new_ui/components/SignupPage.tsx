...
export function SignupPage({ onNavigate }: SignupPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Left Side - Gradient */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-cyan-500 p-12 items-center justify-center">
        <div className="max-w-md space-y-6 text-white">
          ...
          <h2 className="text-white">Start your secure file sharing journey</h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-600">Start sharing files securely in minutes</p>
          </div>
